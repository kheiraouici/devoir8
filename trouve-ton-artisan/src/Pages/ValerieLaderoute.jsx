...
const ValerieLaderoute  =()=>{
    return(
        <><h1> laderoute valerie</h1>
        
         <section className="ficheartisan">
          <img src="../../assets/images/artisanat.jpg" alt="artisanat" />
            <span>nom: Valérie Laderoute</span>
            <span>spécialité :Toiletteur </span>
            <span>note :4.5</span>
            ...
            <span>Email :v-laredoute@gmail.com </span>
            <span>site web</span>
...
export default ValerieLaderoute